...
export const SKILLS = [
  ...
  { id: 'database-migrations', name: 'Database migrations', description: 'Evolve schemas with zero downtime — expand/contract, online indexes, batched backfills, reversible steps (Postgres, Prisma, Drizzle).', roles: ['sw_engineer'], source: 'https://github.com/affaan-m/ECC' },
  { id: 'deployment-patterns', name: 'Deployment & CI/CD', description: 'Ship safely — rolling/blue-green/canary strategies, multi-stage Docker, health checks, rollbacks, and a production-readiness checklist.', roles: ['sw_engineer'], source: 'https://github.com/affaan-m/ECC' },
  { id: 'architecture-decision-records', name: 'Architecture decision records', description: 'Capture significant technical decisions as ADRs — context, alternatives with why-not, decision, and consequences.', roles: ['sw_engineer'], source: 'https://github.com/affaan-m/ECC' },
  { id: 'accessibility',      name: 'Accessibility (WCAG)',  description: 'Build and review to WCAG 2.2 (POUR) — semantic elements, focus management, labels/ARIA, contrast, and keyboard support.', roles: ['designer', 'qa'], source: 'https://github.com/affaan-m/ECC' },
...
const TASK_KEYWORDS = {
  ...
  'engineering-patterns': ['api', 'backend', 'frontend', 'architecture', 'cache', 'endpoint', 'e2e', 'rest', 'error handling'],
  'database-migrations': ['migration', 'migrate', 'schema', 'database', 'alter table', 'zero-downtime', 'backfill', 'prisma', 'drizzle'],
  'deployment-patterns': ['deploy', 'deployment', 'ci/cd', 'pipeline', 'docker', 'rollback', 'release', 'canary', 'blue-green', 'health check', 'production'],
  'architecture-decision-records': ['adr', 'architecture decision', 'decision record', 'design decision', 'rationale', 'why did we'],
  'accessibility': ['accessibility', 'a11y', 'wcag', 'screen reader', 'aria', 'keyboard nav', 'contrast', 'focus'],
